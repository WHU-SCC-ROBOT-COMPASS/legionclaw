...
void DdsMessageManager<T>::HandleParkingInfoMessage(
  ...
  parking_info.set_parking_type(
      (legionclaw::common::ParkingType)msg->parking_type());
  ...
  for (auto it_parking_stoppers : msg->parking_stoppers()) {
    ...
    legionclaw::interface::Point3D parking_info_parking_stopper_center_point_vehicle;
...
void DdsMessageManager<T>::HandlePredictionObstaclesMessage(
  ...
  std::vector<legionclaw::interface::PredictionObstacle> prediction_obstacles_vector;
  for (auto it_prediction_obstacles_vector : msg->prediction_obstacles()) {
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle.set_type(
        (legionclaw::common::ObstacleType)it_prediction_obstacles_vector
            .perception_obstacle()
            .type());
    prediction_obstacles_prediction_obstacle_perception_obstacle
        .set_lane_position(
    ...
    prediction_obstacles_prediction_obstacle_perception_obstacle.set_sub_type(
        (legionclaw::common::ObstacleSubType)it_prediction_obstacles_vector
            .perception_obstacle()
            .sub_type());
    prediction_obstacles_prediction_obstacle_perception_obstacle
    ...
    prediction_obstacles_prediction_obstacle_intent.set_type(
        (legionclaw::interface::ObstacleIntent::Type)it_prediction_obstacles_vector
            .intent()
            .type());
...
void DdsMessageManager<T>::HandleLaneListMessage(
  ...
  lane_list_hpp.set_planning_source(
      (legionclaw::interface::HolisticPathPrediction::PlanningSource)msg->hpp()
          .planning_source());
