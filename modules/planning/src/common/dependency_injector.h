/******************************************************************************
 * Copyright 2020 The LegionClaw Authors. All Rights Reserved.
 *
...
class DependencyInjector {
 public:
  ...
  legionclaw::common::VehicleStateProvider* vehicle_state() {
 ...
 protected:
  ...
  // History history_;
  legionclaw::common::VehicleStateProvider vehicle_state_;
};
