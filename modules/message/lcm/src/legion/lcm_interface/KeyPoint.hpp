...
#ifndef __lcm_interface_KeyPoint_hpp__
#define __lcm_interface_KeyPoint_hpp__
...
int KeyPoint::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int KeyPoint::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int KeyPoint::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t KeyPoint::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* KeyPoint::getTypeName()
{
    return "KeyPoint";
}

int KeyPoint::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
    ...
    tlen = __double_encode_array(buf, offset + pos, maxlen - pos, &this->ele, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int KeyPoint::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
    ...
    tlen = __double_decode_array(buf, offset + pos, maxlen - pos, &this->ele, 1);
    if(tlen < 0) return tlen; else pos += tlen;
...
int KeyPoint::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t KeyPoint::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x3f0f6e8e971a42edLL;
