...
#ifndef __lcm_interface_ImageRect_hpp__
#define __lcm_interface_ImageRect_hpp__
...
int ImageRect::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ImageRect::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int ImageRect::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t ImageRect::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* ImageRect::getTypeName()
{
    return "ImageRect";
}

int ImageRect::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int ImageRect::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int ImageRect::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t ImageRect::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x25ad83fdc7a34221LL;
