...
private:
  legionclaw::cyber::Time start_time_;
  legionclaw::cyber::Time end_time_;
...
#define PERF_FUNCTION()                                                        \
  legionclaw::common::util::TimerWrapper _timer_wrapper_(                          \
      legionclaw::common::util::function_signature(AFUNC))
#define PERF_FUNCTION_WITH_NAME(func_name)                                     \
  legionclaw::common::util::TimerWrapper _timer_wrapper_(func_name)
#define PERF_FUNCTION_WITH_INDICATOR(indicator)                                \
  legionclaw::common::util::TimerWrapper _timer_wrapper_(                          \
      legionclaw::common::util::function_signature(AFUNC, indicator))
#define PERF_BLOCK_START()                                                     \
  legionclaw::common::util::Timer _timer_;                                         \
  _timer_.Start()
