 ...
 * Return a failure if the library cannot be loaded or not all Pardiso symbols
 * are found.
 * @param libname The name under which the Pardiso lib can be found, or
 * OSQP_NULL to use a default name (mkl_rt.SHAREDLIBEXT).
