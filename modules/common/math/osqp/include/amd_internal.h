...
GLOBAL size_t AMD_aat(Int n, const Int Ap[], const Int Ai[], Int Len[],
                      Int Tp[], c_float Info[]);

GLOBAL void AMD_1(Int n, const Int Ap[], const Int Ai[], Int P[], Int Pinv[],
                  Int Len[], Int slen, Int S[], c_float Control[],
                  c_float Info[]);

GLOBAL void AMD_postorder(Int nn, Int Parent[], Int Npiv[], Int Fsize[],
                          Int Order[], Int Child[], Int Sibling[], Int Stack[]);

GLOBAL Int AMD_post_tree(Int root, Int k, Int Child[], const Int Sibling[],
                         Int Order[], Int Stack[]
#ifndef NDEBUG
                         ,
                         Int nn
...
GLOBAL void AMD_preprocess(Int n, const Int Ap[], const Int Ai[], Int Rp[],
...
GLOBAL void AMD_dump(Int n, Int Pe[], Int Iw[], Int Len[], Int iwlen, Int pfree,
                     Int Nv[], Int Next[], Int Last[], Int Head[], Int Elen[],
                     Int Degree[], Int W[], Int nel);
