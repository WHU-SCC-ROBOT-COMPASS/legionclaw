 ...
 *******************/
#define OSQP_VERSION                                                           \
  ("0.5.0") /* string literals automatically null-terminated                   \
             */
...
static const char* LINSYS_SOLVER_NAME[] = {"qdldl", "mkl pardiso"};
...
#define RHO_TOL                                                                \
  (1e-04) ///< Tolerance for detecting if an inequality is set to
          // equality
