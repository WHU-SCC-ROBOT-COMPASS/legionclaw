...
#if defined PYTHON
  void (*printf_func)(const char*,
                      ...); /* pointer to printf (in Python it returns void)*/
#elif defined R_LANG
  void (*printf_func)(const char*,
                      ...); /* pointer to printf (in R it returns void)*/
#else
  int (*printf_func)(const char*, ...); /* pointer to printf */
#endif
  c_float (*hypot_func)(c_float, c_float); /* pointer to hypot */
  int (*divcomplex_func)(c_float, c_float, c_float, c_float, c_float*,
                         c_float*);
};
...
int SuiteSparse_divcomplex(c_float ar,
