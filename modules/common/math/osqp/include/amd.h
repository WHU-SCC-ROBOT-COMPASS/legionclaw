...
SuiteSparse_long amd_l_order /* see above for description of arguments */
    (SuiteSparse_long n, const SuiteSparse_long Ap[],
     const SuiteSparse_long Ai[], SuiteSparse_long P[], c_float Control[],
     c_float Info[]);
...
void amd_2(int n, int Pe[], int Iw[], int Len[], int iwlen, int pfree, int Nv[],
           int Next[], int Last[], int Head[], int Elen[], int Degree[],
           int W[], c_float Control[], c_float Info[]);

void amd_l2(SuiteSparse_long n, SuiteSparse_long Pe[], SuiteSparse_long Iw[],
            SuiteSparse_long Len[], SuiteSparse_long iwlen,
            SuiteSparse_long pfree, SuiteSparse_long Nv[],
            SuiteSparse_long Next[], SuiteSparse_long Last[],
            SuiteSparse_long Head[], SuiteSparse_long Elen[],
            SuiteSparse_long Degree[], SuiteSparse_long W[], c_float Control[],
            c_float Info[]);
...
int amd_valid(int n_row,      /* # of rows */
              int n_col,      /* # of columns */
              const int Ap[], /* column pointers, of size n_col+1 */
              const int Ai[]  /* row indices, of size Ap [n_col] */
);

SuiteSparse_long amd_l_valid(SuiteSparse_long n_row, SuiteSparse_long n_col,
...
#define AMD_OK_BUT_JUMBLED                                                     \
  1 /* input matrix is OK for amd_order, but                                   \
     * columns were not sorted, and/or duplicate entries were present.  AMD    \
     * had to do extra work before ordering the matrix.  This is a warning,              \
     * not an error.  */
