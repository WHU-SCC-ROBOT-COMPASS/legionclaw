...
template <typename T> void Ros2MessageManager<T>::Init(T* t) {
  ...
  routing_response_pub_ =
      create_publisher<::ros2_interface::msg::RoutingResponse>(
          "/routing/RoutingResponse", QoS{10}, PubAllocT{});
  
  guide_info_pub_ = create_publisher<::ros2_interface::msg::GuideInfo>("/routing/GuideInfo", QoS{10}, PubAllocT{});

  lane_list_pub_ = create_publisher<::ros2_interface::msg::LaneList>("/routing/LaneList", QoS{10}, PubAllocT{});

  parking_info_pub_ = create_publisher<::ros2_interface::msg::ParkingInfo>(
      "/routing/ParkingInfo", QoS{10}, PubAllocT{});

  stop_info_pub_ = create_publisher<::ros2_interface::msg::StopInfo>(
      "/routing/StopInfo", QoS{10}, PubAllocT{});

  global_route_msg_pub_ =
      create_publisher<::ros2_interface::msg::GlobalRouteMsg>(
          "/routing/GlobalRouteMsg", QoS{10}, PubAllocT{});

navi_info_msg_pub_ = create_publisher<::ros2_interface::msg::NaviInfoMsg>("/routing/NaviInfoMsg",
                                                                            QoS{10}, PubAllocT{});  

faults_pub_ = create_publisher<::ros2_interface::msg::Faults>(
      "/routing/Faults", QoS{10}, PubAllocT{});

  polygon_2d_pub_ = create_publisher<::ros2_interface::msg::Polygon2D>(
      "/routing/MapBoundary", QoS{10}, PubAllocT{});

  traffic_events_output_pub_ =
      create_publisher<::ros2_interface::msg::TrafficEvents>(
          "/routing/TrafficEvents", QoS{10}, PubAllocT{});

  traffic_light_msg_sub_ = create_subscription<TrafficLightMsg>(
      "/perception/fusion/traffic_sign_fusion/TrafficLightMsg", QoS{30},
  ...
  odometry_sub_ = create_subscription<Odometry>(
      "/localization/local_map_location/Map2LocalTF", QoS{30},
  ...
  routing_request_sub_ = create_subscription<RoutingRequest>(
      "/vui_client/RoutingRequest", QoS{30},
...
void Ros2MessageManager<T>::TaskStart()
{
  ...
  traffic_light_msg_sub_ = create_subscription<TrafficLightMsg>("/perception/fusion/traffic_sign_fusion/TrafficLightMsg", QoS{30},[this](const ros2_interface::msg::TrafficLightMsg::SharedPtr msg){Ros2MessageManager::HandleTrafficLightMsgMessage(msg);} ,SubAllocT{});

  location_sub_ = create_subscription<Location>("/localization/global_fusion/Location", QoS{30},[this](const ros2_interface::msg::Location::SharedPtr msg){Ros2MessageManager::HandleLocationMessage(msg);} ,SubAllocT{});

  chassis_sub_ = create_subscription<Chassis>("/drivers/canbus/Chassis", QoS{30},[this](const ros2_interface::msg::Chassis::SharedPtr msg){Ros2MessageManager::HandleChassisMessage(msg);} ,SubAllocT{});

  traffic_events_input_sub_ = create_subscription<TrafficEvents>("/vui_client/SpeedLimit", QoS{30},[this](const ros2_interface::msg::TrafficEvents::SharedPtr msg){Ros2MessageManager::HandleTrafficEventsInputMessage(msg);} ,SubAllocT{});

  odometry_sub_ = create_subscription<Odometry>("/localization/local_map_location/Map2LocalTF", QoS{30},[this](const ros2_interface::msg::Odometry::SharedPtr msg){Ros2MessageManager::HandleOdometryMessage(msg);} ,SubAllocT{});

  routing_request_sub_ = create_subscription<RoutingRequest>("/vui_client/RoutingRequest", QoS{30},[this](const ros2_interface::msg::RoutingRequest::SharedPtr msg){Ros2MessageManager::HandleRoutingRequestMessage(msg);} ,SubAllocT{});
...
template <typename T>
void Ros2MessageManager<T>::PublishGuideInfo(legionclaw::interface::GuideInfo msg) {
...
template <typename T>
void Ros2MessageManager<T>::PublishLaneList(legionclaw::interface::LaneList msg) {
  if (is_active_ == false) return;
...
template <typename T>
void Ros2MessageManager<T>::PublishStopInfo(legionclaw::interface::StopInfo msg) {
  if (is_init_ == false)
    return;
...
template <typename T>
void Ros2MessageManager<T>::PublishPolygon2D(legionclaw::interface::Polygon2D msg) {
  if (is_init_ == false)
    return;
...
template <typename T>
void Ros2MessageManager<T>::PublishNaviInfoMsg(legionclaw::interface::NaviInfoMsg msg)
{
  if (is_active_ == false) return;
  ::ros2_interface::msg::NaviInfoMsg navi_info_msg;
  MESSAGE_HEADER_ASSIGN(ros2_interface::msg, navi_info_msg)
