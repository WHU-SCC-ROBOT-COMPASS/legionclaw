...
//get route产生轨迹的属性
  ...
  /**
     ...
     * @param map [地图]
     * @param point [坐标，虽然是gps点，但是目前传入ENU坐标,有z坐标]
     * @return lanelet的id集合
     */
  ...
  /**
     ...
     * @param point [坐标，虽然是gps点，但是目前传入ENU坐标，有z坐标]
     * @param theta [航向，正北为0，顺时针增加]
     * @param range [距离搜索阈值,2d]
     * @param weight_times [角度偏差所占权重的计算倍数]
     * @param height_range [海拔匹配限差]
     * @return 最近的中心线上的点，和该车道id的pair,如果找不到，则id返回-1
     */
