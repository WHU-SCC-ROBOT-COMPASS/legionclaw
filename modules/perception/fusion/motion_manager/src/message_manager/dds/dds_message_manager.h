...
protected:
  ...
  void
  HandleINObstacleListMessage(const ros2_interface::msg::ObstacleList *msg);

private:
  ros2_interface::msg::ObstacleList out_obstacle_list;
  eprosima::fastdds::dds::DomainParticipant *participant_;
  eprosima::fastdds::dds::Publisher *publisher_;
  eprosima::fastdds::dds::Topic *topic_;

  eprosima::fastdds::dds::DataWriter *out_obstacle_list_writer_;
  std::unique_ptr<eprosima::fastdds::dds::TypeSupport> out_obstacle_list_type_;
  ...
  eprosima::fastdds::dds::DataReader *in_obstacle_list_reader_;
  std::unique_ptr<eprosima::fastdds::dds::TypeSupport> in_obstacle_list_type_;
};
} // namespace fusion
} // namespace perception
} // namespace legion
