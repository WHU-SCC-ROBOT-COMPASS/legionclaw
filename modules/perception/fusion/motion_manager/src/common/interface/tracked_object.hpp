...
#include "tracked_object_kinematics.hpp"
...
public:
    ...
    inline void set_kinematics(const motion_manager::interface::TrackedObjectKinematics& kinematics)
    {
        kinematics_ = kinematics;
        kinematics_ptr_ = &kinematics_;
    }

    inline const motion_manager::interface::TrackedObjectKinematics& kinematics() const
    {
        return kinematics_;
    }

    inline motion_manager::interface::TrackedObjectKinematics* mutable_kinematics()
    {
        return& kinematics_;
    }
...
void operator = (const TrackedObject& tracked_object){
    CopyFrom(tracked_object);
  }

  void CopyFrom(const TrackedObject& tracked_object ){
    object_id_ = tracked_object.object_id();
    existence_probability_ = tracked_object.existence_probability();
    classification_ = tracked_object.classification();
    kinematics_ = tracked_object.kinematics();
    shape_ = tracked_object.shape();
  }
...
protected:
    ...
    motion_manager::interface::TrackedObjectKinematics kinematics_;
    motion_manager::interface::TrackedObjectKinematics* kinematics_ptr_ = nullptr;
