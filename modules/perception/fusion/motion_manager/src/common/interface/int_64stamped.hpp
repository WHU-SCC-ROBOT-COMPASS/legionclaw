...
public:
    ...
    inline void set_data(const int64_t& data)
    {
        data_ = data;
        data_ptr_ = &data_;
    }
...
void operator = (const Int64Stamped& int_64stamped){
    CopyFrom(int_64stamped);
  }

  void CopyFrom(const Int64Stamped& int_64stamped ){
    stamp_ = int_64stamped.stamp();
    data_ = int_64stamped.data();
  }
