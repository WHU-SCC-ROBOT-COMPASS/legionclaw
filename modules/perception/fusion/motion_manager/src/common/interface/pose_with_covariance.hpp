...
void operator = (const PoseWithCovariance& pose_with_covariance){
    CopyFrom(pose_with_covariance);
  }

  void CopyFrom(const PoseWithCovariance& pose_with_covariance ){
    pose_ = pose_with_covariance.pose();
    covariance_ = pose_with_covariance.covariance();
  }
