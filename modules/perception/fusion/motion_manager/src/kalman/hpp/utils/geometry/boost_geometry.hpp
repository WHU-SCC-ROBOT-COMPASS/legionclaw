...
// inline motion_manager::interface::Point3D toMsg(const Point3d & point)
// {
//   motion_manager::interface::Point3D msg;
//   msg.set_x(point.x());
//   msg.set_y(point.y());
//   msg.set_z(point.z());
//   return msg;
...
// inline Point3d fromMsg(const motion_manager::interface::Point3D & msg)
// {
//   Point3d point;
//   point.x() = msg.x();
//   point.y() = msg.y();
...
BOOST_GEOMETRY_REGISTER_POINT_2D(                                       // NOLINT
  utils::Point2d, double, cs::cartesian, x(), y())       // NOLINT
BOOST_GEOMETRY_REGISTER_POINT_3D(                                       // NOLINT
  utils::Point3d, double, cs::cartesian, x(), y(), z())  // NOLINT
