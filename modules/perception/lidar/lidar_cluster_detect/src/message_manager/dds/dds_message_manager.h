...
protected:
  ...
  void HandleNoGroundPointsMessage(const ros2_interface::msg::PointCloud* msg);

private:
  ros2_interface::msg::ObstacleList lcd_obstacle_list;
  ros2_interface::msg::Faults faults;
  eprosima::fastdds::dds::DomainParticipant* participant_;
  eprosima::fastdds::dds::Publisher* publisher_;

  eprosima::fastdds::dds::DataWriter* lcd_obstacle_list_writer_;
  std::unique_ptr<eprosima::fastdds::dds::TypeSupport> lcd_obstacle_list_type_;
  eprosima::fastdds::dds::Topic* lcd_obstacle_list_topic_;
  ...
  eprosima::fastdds::dds::DataReader* no_ground_points_reader_;
