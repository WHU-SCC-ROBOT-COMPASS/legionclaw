...
template <typename T> void Ros2MessageManager<T>::Init(T* t) {
  ...
  prediction_obstacles_pub_ =
      create_publisher<::ros2_interface::msg::PredictionObstacles>(
          "/prediction/PredictionObstacles", QoS{10}, PubAllocT{});

  faults_pub_ = create_publisher<::ros2_interface::msg::Faults>(
      "/prediction/Faults", QoS{10}, PubAllocT{});
  ...
  obstacle_list_sub_ = create_subscription<ObstacleList>(
      "/perception/fusion/motion_manager/MMObstacleList", QoS{30},
  ...
  traffic_events_sub_ = create_subscription<TrafficEvents>(
      "/routing/TrafficEventsLocal", QoS{30},
