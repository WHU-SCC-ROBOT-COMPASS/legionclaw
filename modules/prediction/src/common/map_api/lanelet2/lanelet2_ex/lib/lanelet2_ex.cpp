...
namespace lanelet2_ex
{
                                ...
                                const double x, const double y) 
    {
        ...
        return legionclaw::common::math::InterpolateUsingLinearApproximation(p0, p1, p0.s() + delta_s);
    }
    ...
    Lan_Atr GetLanAtr(const lanelet::ConstPoint3d point, const double angle, const lanelet::ConstLineString3d cline, const Trajectory_dir dir)
    {
        ...
        double dist_min = legionclaw::common::math::Norm(matched_path_point.x()-point.x(), matched_path_point.y()-point.y());
        double sign = legionclaw::common::math::CrossProd({path_line[index_start].x(), path_line[index_start].y()}, 
                                                    {point.x(), point.y()}, 
        ...
        double lat_angle = legionclaw::common::math::GetHeading(point.x(), point.y(), matched_path_point.x(), matched_path_point.y());
    ...
    */
    ...
    {
        std::vector<std::pair<std::vector<legionclaw::interface::Point3D>, lanelet2_ex::Lan_Atr>> result;
        for (auto path : paths)
        {
    ...
    {
        std::vector<std::vector<std::pair<std::vector<legionclaw::interface::Point3D>, lanelet2_ex::Lan_Atr>>> all_routes;
        all_routes.clear();
        ...
        {
            std::vector<std::pair<std::vector<legionclaw::interface::Point3D>, lanelet2_ex::Lan_Atr>> all_trajectory;
            all_trajectory.clear();
            std::pair<lanelet::Id, lanelet::Id> besides;
