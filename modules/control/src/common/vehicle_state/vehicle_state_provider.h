...
using legionclaw::interface::Header;
...
class VehicleStateProvider {
 public:
   ...
   */
  Status Update(const legionclaw::interface::LocalizationEstimate& localization,
 ...
 private:
  ...
  legionclaw::interface::LocalizationEstimate original_localization_;
